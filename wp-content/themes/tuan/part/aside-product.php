<aside class="col-lg-4">
   <div class="">
       <div class="widget woocommerce widget_product_categories">
           ...
           <ul class="product-categories">
               <li class="cat-item cat-parent">
                   <a href="shop-right.html" class="active">Insulation</a>
                   <ul class="children">
                       <li class="cat-item">
                           <a href="shop-right.html">Waterproofing</a>
                       </li>
                       <li class="cat-item">
                           <a href="shop-right.html">Fiberglass</a>
                       </li>
                   </ul>
               </li>
               <li class="cat-item cat-parent">
                   <a href="shop-right.html">Cellulose</a>
               </li>
               <li class="cat-item cat-parent">
                   <a href="shop-right.html">Spray Foam</a>
               </li>
               <li class="cat-item cat-parent">
                   <a href="shop-right.html">Air Sealing</a>
               </li>
               <li class="cat-item cat-parent">
                   <a href="shop-right.html">Sound Control</a>
               </li>
               <li class="cat-item cat-parent">
                   <a href="shop-right.html">Venting</a>
               </li>
           </ul>
       </div>
       ...
       <div class="widget woocommerce widget_recently_viewed_products">
           ...
           <h5 class="widget-title">Nổi bật</h5>

           <ul class="product_list_widget">
               <li>
                   <a href="shop-product-right.html">
                       <img src="<?= ASSET?>/images/shop/05.jpg" alt="">
                       <span class="product-title">Cathedral Ceilings</span>
                   </a>
               ...
               <li>
                   <a href="shop-product-right.html">
                       ...
                       <span class="product-title">Retrofits Existing</span>
                   </a>
                   <div class="d-flex justify-content-between rating-product">
                       <div class="star-rating">
												<span style="width:80%">Rated
               ...
               <li>
                   <a href="shop-product-right.html">
                       ...
                       <span class="product-title">New Construction</span>
                   </a>
                   <div class="d-flex justify-content-between rating-product">
                       <div class="star-rating">
												<span style="width:80%">Rated
